...
FAQ = {
    "en": {
        ...
        "items": [
            ...
            {"q": "What does the tour cost?", "a": "€149 per person. The optional homemade snack is +€10 per person. The dog kennel is free."},
    ...
    "sl": {
        ...
        "items": [
            ...
            {"q": "Koliko stane izlet?", "a": "149 EUR na osebo. Domač prigrizek po izbiri stane dodatnih 10 EUR na osebo. Pasja kletka je brezplačna."},
    ...
    "it": {
        ...
        "items": [
            ...
            {"q": "Quanto costa il tour?", "a": "149 EUR a persona. Lo snack fatto in casa opzionale costa 10 EUR a persona in più. Il trasportino per cani è gratuito."},
    ...
    "de": {
        ...
        "items": [
            ...
            {"q": "Was kostet die Tour?", "a": "149 EUR pro Person. Der optionale hausgemachte Snack kostet zusätzlich 10 EUR pro Person. Die Hundebox ist kostenlos."},
